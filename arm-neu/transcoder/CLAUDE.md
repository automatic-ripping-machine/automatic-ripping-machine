...
Auto-memory for this repo lives at `../arm-ai/arm-transcoder/memory/` (start with `MEMORY.md`). Read and write memories there, not in this repo.

## Commit Rules

Engineering standards (branching, PR targets, CI gates, deploy commands) are in `../arm-ai/commit-rules.md` and `../arm-ai/arm-transcoder/commit-rules.md`. Follow both before committing.

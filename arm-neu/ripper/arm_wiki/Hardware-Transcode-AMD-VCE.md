...
You can either follow along the [commands](https://github.com/uprightbass360/automatic-ripping-machine-neu/blob/main/scripts/installers/ubuntu-quicksync.sh) or you can run:

 ```
 sudo apt install wget
 wget https://github.com/uprightbass360/automatic-ripping-machine-neu/blob/main/scripts/installers/ubuntu-quicksync.sh 

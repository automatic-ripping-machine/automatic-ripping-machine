...
from crud import create_job, get_ripper_settings, update_ui_settings, get_ui_settings, get_apprise_settings, \
    get_abcde_settings,update_abcde_settings, get_stats, update_ripper_settings, update_apprise_settings, update_password
...
def save_abcde_config(new_abcde):
    return update_abcde_settings(new_abcde)
